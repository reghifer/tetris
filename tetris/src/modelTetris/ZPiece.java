...
public class ZPiece extends Piece{
	...
	public ZPiece(ModelTetris grid) {
		super(grid, Tile.z);
	}
	...
	public void place() {
		...
		this.block1 = new Coord(4,22);
		this.block2 = new Coord(5,22);
	...
	public void fall() {
		...
		case top:
			...
			canFall = canFall && grid.canGoHere(new Coord(block1.getKey(),block1.getValue() - 1));
			canFall = canFall && grid.canGoHere(new Coord(block4.getKey(),block4.getValue() - 1));
			break;
		case left:
		case right:
			canFall = grid.canGoHere(new Coord(block4.getKey(),block4.getValue() - 1));
	...
	public void left() {
		...
		case left:
		case right:
			canLeft = grid.canGoHere(new Coord(block3.getKey() - 1,block3.getValue()));
	...
	protected boolean rightPos() {
		grid.eraseCurrPiece();
		boolean canGo = grid.canGoHere(new Coord(center.getKey() + 1,center.getValue() + 1));
		canGo = canGo && grid.canGoHere(new Coord(center.getKey() + 1,center.getValue()));
		canGo = canGo && grid.canGoHere(new Coord(center.getKey(),center.getValue()));
